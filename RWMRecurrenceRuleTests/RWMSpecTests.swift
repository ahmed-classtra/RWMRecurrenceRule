...
class RWMSpecTests: RWMRecurrenceRuleBase {
    ...
    func testRule01() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;COUNT=10", dtStart: dtStart, results:
    ...
    func testRule02() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;UNTIL=19971224T000000Z", dtStart: dtStart, results:
            ["1997-09-02T09:00:00", "1997-09-03T09:00:00", "1997-09-04T09:00:00", "1997-09-05T09:00:00",
             "1997-09-06T09:00:00", "1997-09-07T09:00:00", "1997-09-08T09:00:00", "1997-09-09T09:00:00",
    ...
    func testRule03() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;INTERVAL=2", dtStart: dtStart, max: 15, results:
    ...
    func testRule04() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;INTERVAL=10;COUNT=5", dtStart: dtStart, results:
    ...
    func testRule05() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1998, month: 1, day: 1, hour: 9))!
        run(rule: "RRULE:FREQ=YEARLY;UNTIL=20000131T140000;BYMONTH=1;BYDAY=SU,MO,TU,WE,TH,FR,SA", dtStart: dtStart, results:
    ...
    func testRule06() {
        ...
        // Every day in January, for 3 years
        let dtStart = calendar.date(from: DateComponents(year: 1998, month: 1, day: 1, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;UNTIL=20000131T140000;BYMONTH=1", dtStart: dtStart, results:
            ["1998-01-01T09:00:00", "1998-01-02T09:00:00", "1998-01-03T09:00:00", "1998-01-04T09:00:00",
             "1998-01-05T09:00:00", "1998-01-06T09:00:00", "1998-01-07T09:00:00", "1998-01-08T09:00:00",
             "1998-01-09T09:00:00", "1998-01-10T09:00:00", "1998-01-11T09:00:00", "1998-01-12T09:00:00",
             "1998-01-13T09:00:00", "1998-01-14T09:00:00", "1998-01-15T09:00:00", "1998-01-16T09:00:00",
    ...
    func testRule07() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=WEEKLY;COUNT=10", dtStart: dtStart, results:
    ...
    func testRule08() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=WEEKLY;UNTIL=19971224T000000Z", dtStart: dtStart, results:
            ["1997-09-02T09:00:00", "1997-09-09T09:00:00", "1997-09-16T09:00:00", "1997-09-23T09:00:00",
             "1997-09-30T09:00:00", "1997-10-07T09:00:00", "1997-10-14T09:00:00", "1997-10-21T09:00:00",
    ...
    func testRule09() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=WEEKLY;INTERVAL=2;WKST=SU", dtStart: dtStart, max: 15, results:
    ...
    func testRule10() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=WEEKLY;UNTIL=19971007T000000Z;WKST=SU;BYDAY=TU,TH", dtStart: dtStart, results:
    ...
    func testRule11() {
        ...
        // Weekly on Tuesday and Thursday for five weeks
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=WEEKLY;COUNT=10;WKST=SU;BYDAY=TU,TH", dtStart: dtStart, results:
            ["1997-09-02T09:00:00", "1997-09-04T09:00:00", "1997-09-09T09:00:00", "1997-09-11T09:00:00",
             "1997-09-16T09:00:00", "1997-09-18T09:00:00", "1997-09-23T09:00:00", "1997-09-25T09:00:00",
             "1997-09-30T09:00:00", "1997-10-02T09:00:00"]
        )
    ...
    func testRule12() {
        ...
        // Every other week on Monday, Wednesday, and Friday until December 24, 1997, dtStarting on Monday, September 1, 1997
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 1, hour: 9))!
        run(rule: "RRULE:FREQ=WEEKLY;INTERVAL=2;UNTIL=19971224T000000Z;WKST=SU;BYDAY=MO,WE,FR", dtStart: dtStart, results:
    ...
    func testRule13() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=WEEKLY;INTERVAL=2;COUNT=8;WKST=SU;BYDAY=TU,TH", dtStart: dtStart, results:
    ...
    func testRule14() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 5, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;COUNT=10;BYDAY=1FR", dtStart: dtStart, results:
    ...
    func testRule15() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 5, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;UNTIL=19971224T000000Z;BYDAY=1FR", dtStart: dtStart, results:
            ["1997-09-05T09:00:00", "1997-10-03T09:00:00", "1997-11-07T09:00:00", "1997-12-05T09:00:00"]
        )
    }
    ...
    func testRule16() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 7, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;INTERVAL=2;COUNT=10;BYDAY=1SU,-1SU", dtStart: dtStart, results:
    ...
    func testRule17() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 22, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;COUNT=6;BYDAY=-2MO", dtStart: dtStart, results:
    ...
    func testRule18() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 28, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTHDAY=-3", dtStart: dtStart, max: 6, results:
    ...
    func testRule19() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;COUNT=10;BYMONTHDAY=2,15", dtStart: dtStart, results:
    ...
    func testRule20() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 30, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;COUNT=10;BYMONTHDAY=1,-1", dtStart: dtStart, results:
    ...
    func testRule21() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 10, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;INTERVAL=18;COUNT=10;BYMONTHDAY=10,11,12,13,14,15", dtStart: dtStart, results:
            ["1997-09-10T09:00:00", "1997-09-11T09:00:00", "1997-09-12T09:00:00", "1997-09-13T09:00:00",
    ...
    func testRule22() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;INTERVAL=2;BYDAY=TU", dtStart: dtStart, max: 18, results:
            ["1997-09-02T09:00:00", "1997-09-09T09:00:00", "1997-09-16T09:00:00", "1997-09-23T09:00:00",
    ...
    func testRule23() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 6, day: 10, hour: 9))!
        run(rule: "RRULE:FREQ=YEARLY;COUNT=10;BYMONTH=6,7", dtStart: dtStart, results:
    ...
    func testRule24() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 3, day: 10, hour: 9))!
        run(rule: "RRULE:FREQ=YEARLY;INTERVAL=2;COUNT=10;BYMONTH=1,2,3", dtStart: dtStart, results:
    ...
    func testRule25() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 1, day: 1, hour: 9))!
        run(rule: "RRULE:FREQ=YEARLY;INTERVAL=3;COUNT=10;BYYEARDAY=1,100,200", dtStart: dtStart, results:
    ...
    func testRule26() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 5, day: 19, hour: 9))!
        run(rule: "RRULE:FREQ=YEARLY;BYDAY=20MO", dtStart: dtStart, max: 3, results:
    ...
    func testRule27() {
        ...
        // Monday of week number 20 (where the default dtStart of the week is Monday), forever
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 5, day: 12, hour: 9))!
        run(rule: "RRULE:FREQ=YEARLY;BYWEEKNO=20;BYDAY=MO", dtStart: dtStart, max: 3, results:
    ...
    func testRule28() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 3, day: 13, hour: 9))!
        run(rule: "RRULE:FREQ=YEARLY;BYMONTH=3;BYDAY=TH", dtStart: dtStart, max: 11, results:
    ...
    func testRule29() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 6, day: 5, hour: 9))!
        run(rule: "RRULE:FREQ=YEARLY;BYDAY=TH;BYMONTH=6,7,8", dtStart: dtStart, max: 39, results:
    ...
    func testRule30() {
        ...
        // NOTE: The spec example for this includes EXDATE;TZID=America/New_York:19970902T090000 so the dtStart date
        //       isn't returned. This test doesn't support that so this results in that one extra date.
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 2, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=FR;BYMONTHDAY=13", dtStart: dtStart, max: 6, results:
    ...
    func testRule31() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 13, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=SA;BYMONTHDAY=7,8,9,10,11,12,13", dtStart: dtStart, max: 10, results:
    ...
    func testRule32() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1996, month: 11, day: 5, hour: 9))!
        run(rule: "RRULE:FREQ=YEARLY;INTERVAL=4;BYMONTH=11;BYDAY=TU;BYMONTHDAY=2,3,4,5,6,7,8", dtStart: dtStart, max: 3, results:
    ...
    func testRule33() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 4, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;COUNT=3;BYDAY=TU,WE,TH;BYSETPOS=3", dtStart: dtStart, results:
    ...
    func testRule34() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 9, day: 29, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=MO,TU,WE,TH,FR;BYSETPOS=-2", dtStart: dtStart, max: 7, results:
    ...
    func testRule40() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 8, day: 5, hour: 9))!
        run(rule: "RRULE:FREQ=WEEKLY;INTERVAL=2;COUNT=4;BYDAY=TU,SU;WKST=MO", dtStart: dtStart, results:
    ...
    func testRule41() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 1997, month: 8, day: 5, hour: 9))!
        run(rule: "RRULE:FREQ=WEEKLY;INTERVAL=2;COUNT=4;BYDAY=TU,SU;WKST=SU", dtStart: dtStart, results:
    ...
    func testRule42() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2007, month: 1, day: 15, hour: 9))!
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTHDAY=15,30;COUNT=5", dtStart: dtStart, results:
