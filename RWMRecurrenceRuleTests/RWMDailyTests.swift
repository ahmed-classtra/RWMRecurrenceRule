...
class RWMDailyTests: RWMRecurrenceRuleBase {
    ...
    func testDaily02() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;INTERVAL=4;COUNT=10", dtStart: dtStart, results:
    ...
    func testDaily03() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=5,6;COUNT=50", dtStart: dtStart, results:
            ["2018-05-17T09:00:00", "2018-05-18T09:00:00", "2018-05-19T09:00:00", "2018-05-20T09:00:00",
             "2018-05-21T09:00:00", "2018-05-22T09:00:00", "2018-05-23T09:00:00", "2018-05-24T09:00:00",
    ...
    func testDaily04() {
        ...
        // Daily in July
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=7;COUNT=50", dtStart: dtStart, results:
    ...
    func testDaily05() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=5,6;INTERVAL=3;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily06() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=7;INTERVAL=2;COUNT=30", dtStart: dtStart, results:
    ...
    func testDaily07() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTHDAY=3,23;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily08() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTHDAY=2,-2;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily09() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYDAY=MO,TU,FR;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily10() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYDAY=WE,TU;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily11() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=5,6;BYMONTHDAY=1,2,3,4,5;COUNT=50", dtStart: dtStart, results:
    ...
    func testDaily12() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=7;BYMONTHDAY=2,4,6,-2,-4;COUNT=50", dtStart: dtStart, results:
            ["2018-05-17T09:00:00", "2018-07-02T09:00:00", "2018-07-04T09:00:00", "2018-07-06T09:00:00",
    ...
    func testDaily13() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=5,6;BYDAY=MO,FR;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily14() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=7;BYDAY=SU,SA;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily15() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTHDAY=5,6,7,8,9,10;BYDAY=MO,FR;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily16() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTHDAY=-1,-2,-3,-4,-5;BYDAY=SU,SA;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily17() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=8,9,10;BYMONTHDAY=5,6,7,8,9,10;BYDAY=MO,FR;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily18() {
        ...
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=1,2;BYMONTHDAY=-1,-2,-3,-4,-5;BYDAY=SU,SA;COUNT=20", dtStart: dtStart, results:
    ...
    func testDaily19() {
        ...
        run(rule: "RRULE:FREQ=DAILY", dtStart: dtStart, max: 10, exclusionDates: [exclusionDate], results:
    ...
    func testDaily20() {
        ...
        // Daily with with exdates. Should give several consecutive days at the same time
        let dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 17, hour: 9))!
        let exclusionDate = dtStart
        run(rule: "RRULE:FREQ=DAILY;COUNT=10", dtStart: dtStart, exclusionDates: [exclusionDate], results:
    ...
    func testDaily21() {
        ...
        run(rule: "RRULE:FREQ=DAILY;COUNT=9", dtStart: dtStart, enumerationStartDate: enumerationStartDate, results:
            ["2018-05-18T09:00:00", "2018-05-19T09:00:00", "2018-05-20T09:00:00",
             "2018-05-21T09:00:00", "2018-05-22T09:00:00", "2018-05-23T09:00:00", "2018-05-24T09:00:00",
             "2018-05-25T09:00:00", "2018-05-26T09:00:00"]
        )
    }
    ...
    func testDaily02e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;INTERVAL=4;COUNT=8", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily03e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=5,6;COUNT=48", dtStart: dtStart, exclusionDates: exclusionDates, results:
            ["2018-05-17T09:00:00", "2018-05-18T09:00:00", "2018-05-19T09:00:00", "2018-05-20T09:00:00",
             "2018-05-21T09:00:00", "2018-05-22T09:00:00", "2018-05-23T09:00:00", "2018-05-24T09:00:00",
    ...
    func testDaily04e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=7;COUNT=48", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily05e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=5,6;INTERVAL=3;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily06e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=7;INTERVAL=2;COUNT=28", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily07e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTHDAY=3,23;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily08e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTHDAY=2,-2;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily09e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYDAY=MO,TU,FR;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily10e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYDAY=WE,TU;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily11e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=5,6;BYMONTHDAY=1,2,3,4,5;COUNT=48", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily12e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=7;BYMONTHDAY=2,4,6,-2,-4;COUNT=48", dtStart: dtStart, exclusionDates: exclusionDates, results:
            ["2018-05-17T09:00:00", "2018-07-02T09:00:00", "2018-07-06T09:00:00",
             "2018-07-28T09:00:00", "2018-07-30T09:00:00", "2019-07-02T09:00:00", "2019-07-04T09:00:00",
             "2019-07-06T09:00:00", "2019-07-28T09:00:00", "2019-07-30T09:00:00", "2020-07-02T09:00:00",
             "2020-07-04T09:00:00", "2020-07-06T09:00:00", "2020-07-28T09:00:00", "2020-07-30T09:00:00",
    ...
    func testDaily13e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=5,6;BYDAY=MO,FR;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily14e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=7;BYDAY=SU,SA;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily15e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTHDAY=5,6,7,8,9,10;BYDAY=MO,FR;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily16e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTHDAY=-1,-2,-3,-4,-5;BYDAY=SU,SA;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily17e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=8,9,10;BYMONTHDAY=5,6,7,8,9,10;BYDAY=MO,FR;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
    ...
    func testDaily18e() {
        ...
        run(rule: "RRULE:FREQ=DAILY;BYMONTH=1,2;BYMONTHDAY=-1,-2,-3,-4,-5;BYDAY=SU,SA;COUNT=18", dtStart: dtStart, exclusionDates: exclusionDates, results:
