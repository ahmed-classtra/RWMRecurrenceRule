...
class RWMEventKitTests: RWMRecurrenceRuleBase {
    ...
    lazy var dtStart = calendar.date(from: DateComponents(year: 2018, month: 5, day: 21, hour: 9))!

    func testA() {
        run(rule: "RRULE:FREQ=DAILY;INTERVAL=1;UNTIL=20180602T055959Z", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testB() {
        run(rule: "RRULE:FREQ=WEEKLY;INTERVAL=1;UNTIL=20180722T055959Z", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testC() {
        run(rule: "RRULE:FREQ=WEEKLY;INTERVAL=2;UNTIL=20180822T055959Z", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testD() {
        run(rule: "RRULE:FREQ=MONTHLY;INTERVAL=1;UNTIL=20190522T055959Z", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testE() {
        run(rule: "RRULE:FREQ=YEARLY;INTERVAL=1;UNTIL=20230521T180000Z", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testF() {
        run(rule: "RRULE:FREQ=DAILY;INTERVAL=3;UNTIL=20180722T055959Z", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testG() {
        run(rule: "RRULE:FREQ=WEEKLY;INTERVAL=2;UNTIL=20180822T055959Z;BYDAY=SU,WE,SA;WKST=SU", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testH() {
        run(rule: "RRULE:FREQ=MONTHLY;INTERVAL=2;UNTIL=20190622T055959Z;BYMONTHDAY=10,15,20", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testI() {
        run(rule: "RRULE:FREQ=MONTHLY;INTERVAL=3;UNTIL=20190622T055959Z;BYDAY=TU;BYSETPOS=2", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testJ() {
        run(rule: "RRULE:FREQ=MONTHLY;INTERVAL=1;BYDAY=SU,MO,TU,WE,TH,FR,SA;BYSETPOS=-1;COUNT=20", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testK() {
        run(rule: "RRULE:FREQ=MONTHLY;INTERVAL=1;UNTIL=20190622T055959Z;BYDAY=SU,SA;BYSETPOS=3", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testL() {
        run(rule: "RRULE:FREQ=YEARLY;INTERVAL=2;UNTIL=20230622T055959Z;BYMONTH=9,10,11", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testM() {
        run(rule: "RRULE:FREQ=YEARLY;INTERVAL=1;UNTIL=20190622T055959Z;BYMONTH=5,7;BYDAY=1WE", mode: .eventKit, dtStart: dtStart, results:
    ...
    func testWeekly1() {
        ...
        run(rule: "RRULE:FREQ=WEEKLY;COUNT=10", mode: .eventKit, dtStart: dtStart, results:
